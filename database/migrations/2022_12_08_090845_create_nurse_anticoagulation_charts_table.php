...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('nurse_anticoagulation_charts', function (Blueprint $table) {
            $table->increments('id');
            $table->string('patient_id');
            $table->string('user_id');
            $table->dateTime('date')->useCurrent();
            $table->integer('tick_for_inr')->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('nurse_anticoagulation_charts');
    }
};
